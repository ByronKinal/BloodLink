export function EmployeeInventoryToolbar({ search, onSearchChange, onCreate }) {
  return (
    <div className="flex flex-col gap-4 p-4 sm:p-5">
      <div className="flex flex-col gap-3 rounded-[16px] border border-gris2 bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(248,247,250,0.94))] p-4 shadow-[0_2px_12px_rgba(17,16,24,0.04)] lg:flex-row lg:items-end lg:justify-between">
        <div className="max-w-[560px]">
          <p className="text-[12px] font-semibold uppercase tracking-[0.1em] text-rojo">Inventario</p>
          <h3 className="mt-1 font-cormorant text-[26px] font-medium leading-none text-txt sm:text-[30px]">Gestiona bolsas de sangre</h3>
        </div>
        ...
        <div className="flex w-full flex-col gap-3 sm:flex-row lg:w-auto">
          <label className="flex-1 min-w-[220px] flex flex-col gap-[5px]">
            ...
            <input
              ...
              placeholder="Buscar por identificador, tipo, donante o estado"
